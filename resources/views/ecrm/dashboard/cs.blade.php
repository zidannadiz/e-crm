...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        <a href="{{ route('ecrm.orders.index', ['status' => 'pending']) }}" 
           class="bg-white rounded-lg shadow-sm border-l-4 border-yellow-500 p-4 hover:shadow-md transition-all duration-300 hover:scale-105 animate-slide-up delay-100">
        ...
        <a href="{{ route('ecrm.messages.inbox') }}" 
           class="bg-white rounded-lg shadow-sm border-l-4 border-blue-500 p-4 hover:shadow-md transition-all duration-300 hover:scale-105 animate-slide-up delay-200">
            <div class="flex items-center justify-between">
                <div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        <div class="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-xl p-6 shadow-sm border border-yellow-200 animate-slide-up delay-100 hover:shadow-lg transition-all duration-300 hover:scale-105 cursor-pointer">
            <div class="flex items-center justify-between">
                <div>
        ...
        <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6 shadow-sm border border-green-200 animate-slide-up delay-200 hover:shadow-lg transition-all duration-300 hover:scale-105 cursor-pointer">
            <div class="flex items-center justify-between">
                <div>
        ...
        <div class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-6 shadow-sm border border-purple-200 animate-slide-up delay-300 hover:shadow-lg transition-all duration-300 hover:scale-105 cursor-pointer">
            <div class="flex items-center justify-between">
                <div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($pending_orders as $index => $order)
                        <tr class="table-row-hover animate-slide-in-left hover:bg-gray-50 transition-all duration-200" style="animation-delay: {{ $index * 0.05 }}s; opacity: 0; animation-fill-mode: forwards;">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-100 text-blue-800 transition-all duration-200 hover:scale-110">
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-8 text-center">
                                <p class="text-gray-500 font-medium animate-fade-in">Belum ada pesanan pending</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
