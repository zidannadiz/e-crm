...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
        <p class="text-yellow-800">
            ...
            <a href="{{ route('ecrm.orders.my') }}" class="underline ml-2">Lihat pesanan saya</a>
        </p>
    </div>
    @endif
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="{{ route('ecrm.orders.my') }}" class="text-blue-600 hover:underline text-sm">Lihat semua →</a>
            </div>
                        ...
                        <div class="border-b pb-4">
                            <div class="flex justify-between items-start">
                                ...
                                <div class="flex gap-2">
                                    ...
                                    <a href="{{ route('ecrm.chat.index', $order) }}" class="text-green-600 hover:underline">Chat</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
            ...
            @else
                ...
                <a href="{{ route('ecrm.orders.create') }}" class="mt-4 inline-block bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="space-y-2">
                <a href="{{ route('ecrm.orders.create') }}" class="block w-full bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 text-center">
                    + Pesan Project Baru
                </a>
                <a href="{{ route('ecrm.orders.my') }}" class="block w-full bg-gray-600 text-white px-4 py-2 rounded hover:bg-gray-700 text-center">
                    Lihat Semua Pesanan
                </a>
            </div>
        </div>
