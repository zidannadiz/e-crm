...
@section('title', 'Ubah Layanan Pelanggan - e-CRM')

@section('content')
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between items-center mb-6 animate-fade-in">
        <h1 class="text-3xl font-bold">Ubah Layanan Pelanggan</h1>
    ...
    <div class="bg-white rounded-lg shadow p-6 animate-slide-up">
        <form action="{{ route('ecrm.customer-services.update', $customerService) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <input type="text" 
                           id="name"
                           name="name" 
                           value="{{ old('name', $customerService->name) }}" 
                           required 
