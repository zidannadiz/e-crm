...
@section('title', 'Tambah Balasan Cepat - e-CRM')
            ...
            <div class="space-y-6">
                ...
                <div class="flex items-center gap-4">
                    <label class="flex items-center">
                        <input type="checkbox" name="use_ai" value="1" {{ old('use_ai') ? 'checked' : '' }} class="rounded border-gray-300">
                ...
                <div class="flex items-center gap-4">
                    <label class="flex items-center">
                        <input type="checkbox" name="aktif" value="1" {{ old('aktif', true) ? 'checked' : '' }} class="rounded border-gray-300">
