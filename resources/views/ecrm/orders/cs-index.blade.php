...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <div class="bg-yellow-50 rounded-lg p-4 border border-yellow-200 animate-slide-up delay-100 hover:shadow-lg transition-all duration-300 hover:scale-105 cursor-pointer">
        ...
        <div class="bg-blue-50 rounded-lg p-4 border border-blue-200 animate-slide-up delay-200 hover:shadow-lg transition-all duration-300 hover:scale-105 cursor-pointer">
            <div class="flex items-center justify-between">
                <div>
        ...
        <div class="bg-green-50 rounded-lg p-4 border border-green-200 animate-slide-up delay-300 hover:shadow-lg transition-all duration-300 hover:scale-105 cursor-pointer">
            <div class="flex items-center justify-between">
                <div>
        ...
        <div class="bg-purple-50 rounded-lg p-4 border border-purple-200 animate-slide-up delay-400 hover:shadow-lg transition-all duration-300 hover:scale-105 cursor-pointer">
            <div class="flex items-center justify-between">
                <div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 mb-6 p-4 animate-slide-up">
        <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <input 
                ...
                class="border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 focus:scale-105">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($orders as $order)
                        <tr class="table-row-hover animate-slide-in-left hover:bg-gray-50 transition-all duration-200" style="animation-delay: {{ $loop->index * 0.05 }}s; opacity: 0; animation-fill-mode: forwards;">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                @endphp
                                <span class="inline-flex px-5 py-1 text-xs font-semibold rounded-full transition-all duration-200 hover:scale-110 {{ $statusColors[$order->status] ?? 'bg-gray-100 text-gray-800' }}">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                <div class="flex items-center gap-2">
                                    <a href="{{ route('ecrm.orders.show', $order) }}" 
                                       class="text-blue-600 hover:text-blue-900 font-medium transition-all duration-200 hover:scale-110">
                                        Lihat
                                    </a>
                                    <span class="text-gray-300">|</span>
                                    <a href="{{ route('ecrm.chat.index', $order) }}" 
                                       class="text-green-600 hover:text-green-900 font-medium transition-all duration-200 hover:scale-110">
                                        Chat
                                    </a>
                                </div>
                            </td>
