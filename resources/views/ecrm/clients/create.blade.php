...
@section('title', 'Tambah Client - e-CRM')

@section('content')
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
    <h1 class="text-3xl font-bold mb-6">Tambah Client</h1>
        ...
        <form action="{{ route('ecrm.clients.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="perusahaan" value="{{ old('perusahaan') }}" class="w-full border rounded px-4 py-2">
